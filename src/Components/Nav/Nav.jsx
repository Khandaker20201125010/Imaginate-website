...
import defaultImage from '../../assets/images/p.png';
    ...
    return (
        <div className="navbar  w-full bg-gradient-to-r from-indigo-950 to-transparent font-bold text-white">
            ...
            <div className="navbar-start">
                ...
                <a className="max-sm:flex max-sm:flex-col lg:flex animate__animated animate__flip ml-10  font-bold">
            ...
            <div className="navbar-end gap-5 mr-5">
                ...
                <div className="dropdown dropdown-end">
                        ...
                        <div className="dropdown dropdown-end">
                            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                                <div className="w-10 rounded-full">
                                    <img alt="User Avatar" referrerPolicy="no-referrer" src={user ? user.photoURL : defaultImage} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* {user && (
                            <>
                                <li className="text-black disabled"><a>{user.displayName}</a></li>
                                <li className="text-black"><a>{user.email}</a></li>
                                <li className="text-black">
                                    {isAdmin ? (
                                        <Link to="/uDashboard/adminProfile">Dashboard</Link>
                                    ) : (
                                        <Link to="/uDashboard/myProfile">Dashboard</Link>
                                    )}
                                </li>
                            </>
                        )} */}
                ...
                {user ?
                    <button onClick={handelSignOut} className="btn bg-gradient-to-r from-violet-950 to-blue-900 hover:bg-blue-900  text-white font-extrabold w-28">Log Out</button>
                    :
                    <NavLink to="/Login">
                        <button className="btn bg-gradient-to-r from-violet-950 to-blue-900 font-extrabold hover:bg-violet-900 text-white w-28">Join us</button>
                    </NavLink>
                }
